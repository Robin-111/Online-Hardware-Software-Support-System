...
List<Complaints> complaintsAss = new ArrayList<>();
		...
		return complaintsAss;
	}

	@Override
	public String updateComplaintStatus(int complaintId, String newStatus) throws ComplaintException {
String res = "Could not find any complaints. Please check Your ComplaintId and try again.";
